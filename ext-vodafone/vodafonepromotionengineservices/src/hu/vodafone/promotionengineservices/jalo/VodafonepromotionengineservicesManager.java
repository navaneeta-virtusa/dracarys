 ...
 */
package hu.vodafone.promotionengineservices.jalo;
...
/**
 * This is the extension manager of the Vodafonepromotionengineservices extension.
 */
public class VodafonepromotionengineservicesManager extends GeneratedVodafonepromotionengineservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(VodafonepromotionengineservicesManager.class);
	 ...
	 */
	public static VodafonepromotionengineservicesManager getInstance()
	{
		return (VodafonepromotionengineservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(VodafonepromotionengineservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public VodafonepromotionengineservicesManager() // NOPMD 
	{
		LOG.debug("constructor of VodafonepromotionengineservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of VodafonepromotionengineservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of VodafonepromotionengineservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
