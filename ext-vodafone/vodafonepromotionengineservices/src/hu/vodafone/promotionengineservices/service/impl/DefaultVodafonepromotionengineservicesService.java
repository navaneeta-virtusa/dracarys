...
public class DefaultVodafonepromotionengineservicesService implements VodafonepromotionengineservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultVodafonepromotionengineservicesService.class);
	...
	{
		return DefaultVodafonepromotionengineservicesService.class.getResourceAsStream("/vodafonepromotionengineservices/sap-hybris-platform.png");
	}
