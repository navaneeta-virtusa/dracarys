 ...
 */
package hu.vodafone.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(VodafoneFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(VodafoneFulfilmentProcessConstants.PARENT_PROCESS);
