 ...
 */
package hu.vodafone.fulfilmentprocess.test.jobs;
...
import hu.vodafone.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = VodafoneFulfilmentProcessConstants.ORDER_PROCESS_NAME;
