 ...
 */
package hu.vodafone.core.constants;

/**
 * Global class for all VodafoneCore constants. You can add global constants for your extension into this class.
 */
public final class VodafoneCoreConstants extends GeneratedVodafoneCoreConstants
{
	public static final String EXTENSIONNAME = "vodafonecore";


	private VodafoneCoreConstants()
	{
		//empty
	}
