 ...
 */
package hu.vodafone.core.suggestion;
...
import hu.vodafone.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/vodafonecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
