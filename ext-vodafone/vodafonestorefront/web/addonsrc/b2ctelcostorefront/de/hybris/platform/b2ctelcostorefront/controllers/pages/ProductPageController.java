...
import de.hybris.platform.b2ctelcostorefront.constants.B2ctelcostorefrontWebConstants;
...
public class ProductPageController extends AbstractPageController
{
			...
			final HttpServletRequest request)
	{
		...
		return TelcoControllerConstants.Views.Fragments.Product.ZoomImagesPopup;
	}
			...
			final HttpServletRequest request)
	{
		...
		return TelcoControllerConstants.Views.Fragments.Product.QuickViewPopup;
	}
			...
			@PathVariable("numberOfReviews") final String numberOfReviews, final Model model, final HttpServletRequest request)
	{
		...
		return TelcoControllerConstants.Views.Fragments.Product.ReviewsTab;
	}
	...
	public String writeReview(@PathVariable final String productCode, final Model model) throws CMSItemNotFoundException
	{
		...
		return TelcoControllerConstants.Views.Pages.Product.WriteReview;
	}
			...
			final HttpServletRequest request) throws CMSItemNotFoundException
	{
		...
		options.addAll(Arrays.asList(ProductOption.BASIC, ProductOption.PRICE, ProductOption.SUMMARY, ProductOption.DESCRIPTION,
				...
				ProductOption.DELIVERY_MODE_AVAILABILITY, ProductOption.BUNDLE));
		...
		model.addAttribute(B2ctelcostorefrontWebConstants.SUPERCATEGORIES_KEY, superCategories);
	}
