 ...
 */
package hu.vodafone.test.setup;
...
import hu.vodafone.test.constants.VodafoneTestConstants;
import hu.vodafone.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = VodafoneTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/vodafonetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/vodafonetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/vodafonetest/import/cstickets.impex");
			...
			importImpexFile(context, "/vodafonetest/import/csquotes.impex");
		}
	}
}
